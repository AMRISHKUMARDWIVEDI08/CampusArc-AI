  ...
  return (
    <main className="login-wrap">
      <section className="card login-card" aria-labelledby="login-title">
        ...
        <p className="muted" style={{ marginTop: 8, lineHeight: 1.5 }}>Use your campus username or email. Wallet signing will be added as a separate authentication path; connecting a wallet alone will never sign you in.</p>
        {params.get('role') ? <p className="label" style={{ marginTop: 16 }}>Requested portal: {params.get('role')}</p> : null}
