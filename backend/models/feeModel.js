...
async function findByStudent(studentId){const r=await db.execute({sql:'SELECT * FROM fees WHERE student_id=? ORDER BY due_date ASC, id ASC',args:[studentId]});return r.rows;}
